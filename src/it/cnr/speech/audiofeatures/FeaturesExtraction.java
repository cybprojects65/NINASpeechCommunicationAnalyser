...
public class FeaturesExtraction{
    protected  int frameLength = 128;
    protected  int shiftInterval = frameLength / 2;
    public int numCepstra = 13;
    protected  int fftSize = frameLength;
    protected  double preEmphasisAlpha = 0.95;
    protected  double lowerFilterFreq = 200;
    protected  double upperFilterFreq = 4000;
    ...
    public double[][] process(short inputSignal[],double samplingRate){
    	...
    	System.out.println("Using framelength = "+frameLength);
        double MFCC[][];
        fft = new FFT();
        // Pre-Emphasis
